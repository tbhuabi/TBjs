(function(window, document, undefined) {
        ...
        function copyRecurse(source, destination) {
            ...
            if (isArray(source)) {
                ...
                if (isBlankObject(source)) {
                    ...
                    if (source && typeof source.hasOwnProperty === "function") {
                        for (key in source) {
    ...
    function jqLiteBuildFragment(html, context) {
        var tmp, tag, wrap, fragment = context.createDocumentFragment(),
            nodes = [],
            i;
                ...
                function scroll(hash) {
                    ...
                    if (!hash) {
                        ...
                        if ((elm = document.getElementById(hash))) {
                            ...
                            if ((elm = getFirstAnchor(document.getElementsByName(hash)))) {
                                scrollTo(elm)
                            } else {
                                if (hash === "top") {
                                    scrollTo(null)
        ...
        function parseDirectiveBindings(directive, directiveName) {
            ...
            if (isObject(bindings.bindToController)) {
                ...
                if (!controller) {
                    ...
                    if (!identifierForController(controller, controllerAs)) {
                            ...
                            if (nodeLinkFn) {
                                ...
                                if (nodeLinkFn.transcludeOnThisElement) {
                                    ...
                                    if (!nodeLinkFn.templateOnThisElement && parentBoundTranscludeFn) {
                                        ...
                                        if (!parentBoundTranscludeFn && transcludeFn) {
                    ...
                    forEach(src, function(value, key) {
                        if (key == "class") {
                            ...
                            if (key == "style") {
                                ...
                                if (key.charAt(0) != "$" && !dst.hasOwnProperty(key)) {
                                    dst[key] = value;
            ...
            function($httpBackend, $$cookieReader, $cacheFactory, $rootScope, $q, $injector) {
                ...
                function sendReq(config, reqData) {
                    var deferred = $q.defer(),
                        ...
                        cache, cachedResp, reqHeaders = config.headers,
    ...
    function LocationHtml5Url(appBase, appBaseNoFile, basePrefix) {
        ...
        this.$$parseLinkUrl = function(url, relHref) {
            ...
            if (isDefined(appUrl = beginsWith(appBase, url))) {
                ...
                if (isDefined(appUrl = beginsWith(appBaseNoFile, url))) {
                    rewrittenUrl = appBaseNoFile + appUrl
                } else {
                    if (appBaseNoFile == url + "/") {
            ...
            while (this.index < this.text.length) {
                ...
                if (ch == "." || this.isNumber(ch)) {
                    ...
                    if (ch == "e" && this.isExpOperator(peekCh)) {
                        ...
                        if (this.isExpOperator(ch) && peekCh && this.isNumber(peekCh) && number.charAt(number.length - 1) == "e") {
                            number += ch
                        } else {
                            if (this.isExpOperator(ch) && (!peekCh || !this.isNumber(peekCh)) && number.charAt(number.length - 1) == "e") {
            ...
            function($templateCache, $http, $q, $sce) {
                function handleRequestFn(tpl, ignoreRequestError) {
                    ...
                    if (isArray(transformResponse)) {
                        ...
                        if (transformResponse === defaultHttpResponseTransform) {
    ...
    var ngBindTemplateDirective = ["$interpolate", "$compile",
    ...
    var ngBindHtmlDirective = ["$sce", "$parse", "$compile",
            ...
            this.$$debounceViewValueCommit = function(trigger) {
                ...
                if (options && isDefined(options.debounce)) {
                    ...
                    if (isNumber(debounce)) {
                        ...
                        if (isNumber(debounce[trigger])) {
                            debounceDelay = debounce[trigger]
                        } else {
                            if (isNumber(debounce["default"])) {
    ...
    var ngModelDirective = ["$rootScope",
        function($rootScope) {
            return {
                restrict: "A",
    ...
    function addSetValidityMethod(context) {
        ...
        function setValidity(validationErrorKey, state, controller) {
            ...
            if (ctrl.$pending && ctrl.$pending[validationErrorKey]) {
                ...
                if (ctrl.$error[validationErrorKey]) {
                    combinedState = false
                } else {
                    if (ctrl.$$success[validationErrorKey]) {
                        combinedState = true
                    } else {
                        combinedState = null
                    }
    ...
    var ngOptionsDirective = ["$compile", "$parse",
    ...
    var ngPluralizeDirective = ["$locale", "$interpolate", "$log",
                    ...
                    return function ngRepeatLink($scope, $element, $attr, ctrl, $transclude) {
                        ...
                        $scope.$watchCollection(rhs, function ngRepeatAction(collection) {
                            var index, length, previousNode = $element[0],
                                nextNode, nextBlockMap = createMap(),
                                collectionLength, key, value, trackById, trackByIdFn, collectionKeys, block, nextBlockOrder, elementsToRemove;
                            if (aliasAs) {
    ...
    var SelectController = ["$element", "$scope", "$attrs",
